                ...
                <div className="container text-center text-md-start mt-5">
                    <div className="row mt-3">
                        ...
                        <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            />
                            <p>
                                <a style={{textDecoration:'none'}} href="/Tours" className="text-white">Book a Tour</a>
                            </p>
                            <p>
                                <a style={{textDecoration:'none'}} href="/contact-Us" className="text-white">Customer feedback</a>
                            </p>
                            <p>
                                <a style={{textDecoration:'none'}} href="/contact-Us" className="text-white">Report a Problem</a>
                            </p>
                            <p>
                                <a style={{textDecoration:'none'}} href="#!" className="text-white">Terms & condition</a>
                            </p>
                        ...
                        <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            />
                            <p>
                                <a style={{textDecoration:'none'}} href="/vendor-SignUp" className="text-white">Join us</a>
                            </p>
                            <p>
                                <a style={{textDecoration:'none'}} href="/vendor-Signin" className="text-white">Sign In</a>
                            </p>
                            <p>
                                <a style={{textDecoration:'none'}} href="/contact-Us" className="text-white">Complain</a>
                            </p>
                            <p>
                                <a style={{textDecoration:'none'}} href="/contact-Us" className="text-white">Contract</a>
                            </p>
                        </div>
